...
;;cols - just a list of columns
;;col-hash - hash that represents: Colmn_Name -> Column_Number
...
; accepts column-hash and columns -> returns list that represents numbers of columns
...
;; selects data from rows according to number-lst (number representation of columns) 
...
(define (project-table input-table cols)
  (table (table-cols input-table) (init-col-hash (make-hash) cols) (project-by-numbers (table-data input-table)  (cols-numbers (table-col-hash input-table) cols))))
